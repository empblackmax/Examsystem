...
<div style="text-align: center">
        ...
        <asp:GridView ID="gvTeacher" runat="server" AutoGenerateColumns="False" BackColor="White"
            BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                Width="517px" OnRowDeleting="gvTeacher_RowDeleting" AllowPaging="True" 
                OnPageIndexChanging="gvTeacher_PageIndexChanging" PageSize="8" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="所教科目">
                    <ItemTemplate>
                        <%#GetKmName(Convert.ToInt32(Eval("ID").ToString()))%>
                    </ItemTemplate>
                </asp:TemplateField>

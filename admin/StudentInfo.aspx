...
<div>
    ...
    <legend class="mailTitle">考生基本信息</legend>
        <br />
        ...
        <asp:TextBox ID="txtKey" runat="server" Height="13px" style="margin-top: 0px"></asp:TextBox>
        ...
        <asp:GridView ID="gvStuInfo" runat="server" AutoGenerateColumns="False" BackColor="White"
            BorderColor="DeepSkyBlue" BorderStyle="None" BorderWidth="1px" 
            CellPadding="3" Width="537px" OnRowDeleting="gvStuInfo_RowDeleting" 
            AllowPaging="True" OnPageIndexChanging="gvStuInfo_PageIndexChanging" 
            PageSize="8" onrowdatabound="gvStuInfo_RowDataBound">

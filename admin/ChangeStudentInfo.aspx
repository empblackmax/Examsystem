...
<body style="text-align: center">
 ...
 <br />
    ...
    <legend class="mailTitle">修改考生信息</legend>
        <br />
        <table align="center" border="0" cellpadding="0" cellspacing="0"   style="width: 341px">
            <tr>
        ...
        <asp:TextBox ID="txtStuPwd" runat="server" MaxLength="12"></asp:TextBox></td>
            ...
            <tr>
                <td colspan="2" style="text-align: center">
                    &nbsp;
        <asp:Button ID="btnSava" runat="server" OnClientClick="return Sure()" OnClick="btnSava_Click" Text="保存" />

...
<div style="text-align: center">
        <br />
        <br />
        选择科目：<asp:DropDownList ID="ddlEkm" runat="server"> </asp:DropDownList>&nbsp;
        选择题型：<asp:DropDownList ID="ddlEtx" runat="server"></asp:DropDownList>&nbsp;
    
       
        <asp:Button ID="btnSerch" runat="server" Text="查看" OnClick="btnSerch_Click" />
        &nbsp;
        <asp:Label ID="Label1" runat="server" Visible="false" Text="当前搜索试题类别："></asp:Label>&nbsp;
        ...
        <asp:GridView ID="gvExaminationInfo" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            onrowdatabound="gvExaminationInfo_RowDataBound">

 ...
 <br />
    ...
    <legend class="mailTitle">试题详细信息</legend>&nbsp; &nbsp; &nbsp;&nbsp;<br />
        ...
        <asp:TextBox ID="txtAnsB" runat="server" TextMode="MultiLine" Width="183px"></asp:TextBox>&nbsp;</td>
            ...
            <tr id="ansC" runat="server">
                <td style="text-align: right" class="style5">
                    &nbsp;选项C：</td>
                <td colspan="2" style="text-align: left" class="style14">
        <asp:TextBox ID="txtAnsC" runat="server" TextMode="MultiLine" Width="182px"></asp:TextBox></td>
            </tr>
            <tr id="ansD" runat="server">
                <td style="text-align: right" class="style5">
                    &nbsp;选项D：</td>
                <td colspan="2" style="text-align: left" class="style14">
        <asp:TextBox ID="txtAnsD" runat="server" TextMode="MultiLine" Width="180px"></asp:TextBox>&nbsp;</td>
            </tr>
            <tr>
                <td style="text-align: right" class="style6">
                    &nbsp;正确选项：</td>
                <td colspan="2" style="text-align: left" class="style13">
        <asp:CheckBoxList ID="rblRightAns" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
